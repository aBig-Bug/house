...
public interface RmMapper {
    //生成等待用户确认订单
    @Insert("insert into RentMessage (rm_user_id,rm_house_id,rm_house_image,rent_date,return_date,rm_money,rm_yajin,isArrearage) values" +
            "(#{rm_user_id},#{rm_house_id},#{rm_house_image},#{rent_date},#{return_date},#{rm_money},#{rm_yajin},1)")
