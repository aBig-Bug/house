...
public interface UserMapper {
    //添加用户
    @Insert("insert into user (user_name,user_password,user_email,user_six,user_phone,user_IdCard,user_realName,user_limit,user_state)" +
            "values (#{user_name},#{user_password},#{user_email},#{user_six},#{user_phone},#{user_IdCard},#{user_realName},1,1)")
