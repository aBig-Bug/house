...
public interface HouseMapper {
    ...
    @Insert("insert into house (house_sentType,house_street,house_xq,house_roof,house_shape,house_area,house_money," +
            "house_moneyType,house_title,house_flag,house_image,admin_issue,house_state,isApproval) values (#{house_sentType},#{house_street}," +
    ...
    @Select("select house_id,house_sentType,house_street,house_xq,house_roof,house_shape,house_area,house_money,house_moneyType,house_title,house_flag,house_image,house_state,isApproval,admin_issue   from house where admin_issue = #{admin_issue}")
    List<House> getMyIssuesById(String admin_issue);

    //得到所有需要审批的信息与房屋状态为正常的
    @Select("select house_id,house_sentType,house_street,house_xq,house_roof,house_shape,house_area,house_money,house_moneyType,house_title,house_flag,house_image,house_state,isApproval,admin_issue   from house where isApproval = 0 and house_state = 1")
    ...
    //重新上线查询信息
    @Select("select house_id,house_sentType,house_street,house_xq,house_roof,house_shape,house_area,house_money,house_moneyType,house_title,house_flag,house_image,house_state,isApproval,admin_issue   from house where isApproval = -1 and house_state = 1 and admin_issue = #{admin_issue}")
    ...
    //查询所有通过核审的房源
    @Select("select house_id,house_sentType,house_street,house_xq,house_roof,house_shape,house_area,house_money,house_moneyType,house_title,house_flag,house_image,house_state,isApproval,admin_issue   from house where isApproval = 1 ")
    List<House> getHouses();

    //查询所有通过核审的房源
    @Select("select house_id,house_sentType,house_street,house_xq,house_roof,house_shape,house_area,house_money,house_moneyType,house_title,house_flag,house_image,house_state,isApproval,admin_issue   from house where isApproval = 1 and house_state = 1")
    ...
    //微信搜索房源模糊查询
    @Select("SELECT house_id,house_sentType,house_street,house_xq,house_roof,house_shape,house_area,house_money,house_moneyType,house_title,house_flag,house_image,house_state,isApproval,admin_issue   FROM house WHERE house_title LIKE  CONCAT('%',#{queryName},'%') AND isApproval = 1 AND house_state=1")
